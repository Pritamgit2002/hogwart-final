...
const hogwart2 = () => {
  return (
    <div className="flex-col bg--400">
      <div className=" mt-30">
        <div
          className="border-2 border-black mx-5 
        w-[535px] md:w-auto  bg-[#CDB090]"
        >
          <div className="text-[30px] md:text-[68px] font-bold font-sans text-center md:pt-10 news-head p-4 tracking-widest overflow-hidden w-auto">
            DUMBLEDORE: DRAFT OR DANGEROUS?
          </div>

          <div className="gap-1 lg:flex gap-y-[-150px]  lg:gap-0">
            {/* 1st panel */}


            <div className=" h-auto w-[95%] lg:w-[65%] m-4">
              <div className="flex md:gap-2">
                ...
                <div className="h-[480px] w-[225px] border-[1px] border-black md:w-[520px]">
                  <video
                    autoPlay
                    loop
                    muted
                    src="/assets/dumb_vid.mp4"
                    className="h-full w-full object-cover grayscale hover:grayscale-0 transition-colors duration-1000 ease-linear p-[0.5px]"
                  />
                </div>
              </div>

              <div className="h-[360px] mt-2 border-[1px] border-black overflow-hidden p-4 text ">
                <div className="sub-head border-b-[2.2px] border-black overflow-hidden">
                  Lorem ipsum dolor sit amet.
                </div>
                ...
                velit, quibusdam ullam tempore, itaque qui doloremque excepturi officia, in eius, exercitationem  enim debitis
            ...
            <div className="bg-yellow-30 m-4 h-screen w-[95%] lg:w-[34%] grid grid-rows-3 grid-flow-col ">
              <div className="flex">
                <div class="flex  h-screen relative border-[1px] border-black">
                  ...
                  <div class="row-span-2  w-[260px] p-4 border-l-[1px] border-black text overflow-hidden">
                    <b>Harry</b> ipsum, dolor sit amet consectetur adipisicing
                ...
                <div class="row-span-3 overflow-hidden p-4 border-[1px] border-black h-screen text">
                  ...
                  laboriosam officia, in eius, exercitationem  enim debitis
                   voluptate accusantium.
                </div>
              </div>
